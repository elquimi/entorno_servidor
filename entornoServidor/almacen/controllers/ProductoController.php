...
class ProductoController {
    ...
    public function index(){
        ...
        require $this->basePath . "/views/clientes/lista.php"; // Muestra la tabla
        require $this->basePath . "/views/clientes/formulario.php"; // Muestra el formulario
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (!empty($cantidad) && !empty($nombre_producto)) {
                ...
                if ($producto_encontrado) {
                    ...
                    $this->model->update($producto_encontrado['id'], $cantidad);
                } else {
                    // NO EXISTE -> CREAR
                    $this->model->create($nombre_producto, $cantidad);
                }
            }
        }
