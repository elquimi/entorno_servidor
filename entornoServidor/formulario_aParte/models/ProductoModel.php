...
class ProductoModel
{
    ...
    public function update($id,$cantidad,$precio,$id):bool
    {
    ...
    public function editar($id,$nombre,$cantidad,$precio,$categoria){
        $editar = $this->pdo->prepare("UPDATE productos SET nombre = ?, categoria = ?, precio = ?, stock = ? WHERE id = ?");
        return $editar->execute([$nombre,$categoria,$precio,$cantidad,$id]);
